...
export default function LoginLayout({ children }: { children: ReactNode }) {
  return (
    <main className="w-full h-screen overflow-hidden flex justify-center items-center bg-background">
      <div className="w-full h-screenflex justify-center items-center border rounded-xl overflow-hidden bg-white lg:w-2/3 lg:h-5/6 lg:grid lg:grid-cols-2 lg:grid-rows-1 lg:gap-5 xl:w-full">
