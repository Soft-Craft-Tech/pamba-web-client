export default function PrivacyPolicy() {
    return (
        <div className="container mx-auto px-10 py-8 text-secondary">
            <h1 className="text-3xl font-bold mb-4 text-primary">Privacy Policy</h1>
            <p className="mb-4">Last updated: March 27, 2024</p>
            <p>
                ...
                Your privacy rights and how the law protects You. We use Your Personal data to provide and improve the Service. 
                By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.
            </p>

            <h2 className="text-2xl font-bold mt-8 mb-4 text-primary">Interpretation and Definitions</h2>
            <h3 className="text-xl font-bold mb-2 text-primary">Interpretation</h3>
            <p>
                The words of which the initial letter is capitalized have meanings defined under the following conditions. 
                The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
            </p>

            <h3 className="text-xl font-bold mt-6 mb-2 text-primary">Definitions</h3>
            <ul className="list-disc pl-8">
                ...
                <li>
                    ...
                    where control means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for the election of directors
                    or other managing authority.
                </li>
                <li>
                    <strong>Application</strong> refers to Pamba Africa, the software program provided by the Company.
                </li>
                <li>
                    <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Zakmi Technologies Ltd
                </li>
                <li>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-primary">Collecting and Using Your Personal Data</h2>
            <h3 className="text-xl font-bold mb-2 text-primary">Types of Data Collected</h3>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-primary">Use of your data</h2>
            ...
            <ul className="list-disc pl-8">
                ...
                <li>
                    To provide You with news, special offers and general information about other goods, services and events which we offer that are similar
                ...
                <li>
                    For business transfers: We may use Your information to evaluate or conduct a merger, divestiture, restructuring, reorganization, 
                    dissolution, or other sale or transfer of some or all of Our assets, whether as a going concern or as part of bankruptcy, liquidation, or 
                    similar proceeding, in which Personal Data held by Us about our Service users is among the assets transferred.
                </li>
                <li>
                    For other purposes: We may use Your information for other purposes, such as data analysis, identifying usage trends, determining
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-primary">Sharing your data</h2>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-primary">Retention of Your Personal Data</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-primary">Transfer of your Personal Data</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-primary">Delete Your Personal Data</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-primary">Disclosure of Your Personal Data</h2>
            <ul className="list-disc pl-8">
                <li>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-primary">Security of Your Personal Data</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-primary">Children&apos;s Privacy</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 text-primary">Changes to this Privacy Policy</h2>
            <p>
            ...
            <ul className="list-disc pl-8">
            <li>By email: <span className="text-primary">info@pamba.africa</span></li>
