  ...
  return (
    <div className="container mx-auto px-10 py-8 text-secondary">
      ...
      <ul className="list-disc pl-8">
        ...
        <li>
          <strong>Application</strong> refers to Pamba Africa, the software
          program provided by the Company.
        </li>
        <li>
          <strong>Company</strong> (referred to as either &quot;the
          Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
          this Agreement) refers to Zakmi Technologies Ltd
        </li>
        <li>
      ...
      <ul className="list-disc pl-8">
        <li>
          By email: <span className="text-primary">info@pamba.africa</span>
        </li>
