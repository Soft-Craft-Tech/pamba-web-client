...
export default function AppSection() {
    return (
        <section className="flex flex-col-reverse px-5 h-auto py-20 bg-secondary text-white gap-10 w-full sm:p-10 lg:h-screen lg:grid lg:grid-cols-9 lg:py-0 lg:grid-rows-1 lg:p-20">
            <div className="flex flex-col text-center justify-center gap-3 sm:gap-5 lg:text-left col-span-4">
                <h3 className="font-extrabold text-3xl sm:text-4xl">Your clients are using the Pamba application to book with you.</h3>
            ...
            <div className="w-full h-80 flex justify-center relative col-span-5 lg:justify-end lg:h-full">
                <Image className="w-auto h-full" src="/pamba-phone.svg" alt="Pamba mobile app" width={0} height={0} priority />
            </div>
        </section>
    )
}